 ...
 * @param  talus_ref Reference talus used to normalize gradient computations. It
 *                   can be useful when working with true angles. Default is
 *                   1.f.
 ...
 * grid-based approach. The shadow talus parameter influences the calculation of
 * shadow intensity.
 *
 * @param  z            Input array representing the heightmap.
 ...
 * the specified light azimuth, zenith, and distance. The method is based on the
 * technique described in https://www.shadertoy.com/view/Xlsfzl.
 *
 * @param  z        Input array representing the heightmap.
 ...
 * based on the sun's azimuth and zenith. The shadow intensity is normalized to
